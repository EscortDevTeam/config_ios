...
class DeviceDUPassword: UIViewController {
    ...
    private func viewShow() {
        ...
        btn4Text.text = "Reloading DU-BLE".localized(code)
...
//
        ...
        alertControllerSecond.view.frame.origin.y = 100
