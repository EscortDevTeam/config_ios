...
class IdCopyCell: UITableViewCell {
    
//    var content: UIView!
    var label: UILabel!
    var labelPassword: UILabel!
    var imageUI: UIButton!
...
//            self.content!.bottomAnchor.constraint(equalTo: self.imageUI!.bottomAnchor, constant: 25),
            ...
            self.imageUI!.leadingAnchor.constraint(equalTo: labelPassword.trailingAnchor, constant: 25),
            self.imageUI!.centerYAnchor.constraint(equalTo: contentView.centerYAnchor),
            self.imageUI!.heightAnchor.constraint(equalToConstant: 35),
            self.imageUI!.widthAnchor.constraint(equalToConstant: 35),
        ])
        setupTheme()
    }
    func setupTheme() {
