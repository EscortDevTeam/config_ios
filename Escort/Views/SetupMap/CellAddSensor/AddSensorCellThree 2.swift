...
class AddSensorCellThree: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        if photoALLPlombaSecondTrack[openSensorNumber-1].count == 3 {
            photoALLPlombaSecondTrack[openSensorNumber-1].removeFirst()
        }
        return photoALLPlombaSecondTrack[openSensorNumber-1].count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageAdd.image = photoALLPlombaSecondTrack[openSensorNumber-1][indexPath.row]
        if photoALLPlombaSecondTrack[openSensorNumber-1][indexPath.row] == UIImage(named: "Group 29-2") || photoALLPlombaSecondTrack[openSensorNumber-1][indexPath.row] == UIImage(named: "Group 29-2N") {
            cell.imageDelete.isHidden = true
        } else {
            cell.imageDelete.isHidden = false
        }
        cell.imageDelete.addTapGesture {
            photoALLPlombaSecondTrack[openSensorNumber-1].remove(at: indexPath.row)
             if photoALLPlombaSecondTrack[openSensorNumber-1].first != UIImage(named: "Group 29-2") && photoALLPlombaSecondTrack[openSensorNumber-1].first != UIImage(named: "Group 29-2N") {
                 UserDefaults.standard.removeObject(forKey: "photoALLPlomba2DUT_\(indexPath.row + 1)\(openSensorNumber-1)")
                photoALLPlombaSecondTrack[openSensorNumber-1].insert(isNight ? #imageLiteral(resourceName: "Group 29-2N") : #imageLiteral(resourceName: "Group 29-2"), at: 0)
             } else {
                 UserDefaults.standard.removeObject(forKey: "photoALLPlomba2DUT_1\(openSensorNumber-1)")
                 UserDefaults.standard.removeObject(forKey: "photoALLPlomba2DUT_2\(openSensorNumber-1)")
             }
            self.collectionView.reloadData()
        }
        cell.addTapGesture {
            if indexPath.row == 0 {
                if (photoALLPlombaSecondTrack[openSensorNumber-1].first == UIImage(named: "Group 29-2") || photoALLPlombaSecondTrack[openSensorNumber-1].first == UIImage(named: "Group 29-2N")) && photoALLPlombaSecondTrack[openSensorNumber-1].count < 3 {
                    ...
                    picker.didFinishPicking { [unowned picker] items, _ in
                        if let photo = items.singlePhoto {
                            ...
                            if let imageData = photo.image.jpeg(.lowest) {
                                photoALLPlombaSecondTrack[openSensorNumber-1].append(UIImage(data: imageData)!)
                                UserDefaults.standard.set(imageData, forKey: "photoALLPlomba2DUT_\(photoALLPlombaSecondTrack[openSensorNumber-1].count-1)\(openSensorNumber-1)")
                    ...
                    if photoALLPlombaSecondTrack[openSensorNumber-1].count == 2 {
                        self.slideshow.setImageInputs([
                            ImageSource(image: photoALLPlombaSecondTrack[openSensorNumber-1][0]),
                            ImageSource(image: photoALLPlombaSecondTrack[openSensorNumber-1][1])
                        ])
                    }
                ...
                if photoALLPlombaSecondTrack[openSensorNumber-1].count == 2  && (photoALLPlombaSecondTrack[openSensorNumber-1].first == UIImage(named: "Group 29-2") || photoALLPlombaSecondTrack[openSensorNumber-1].first == UIImage(named: "Group 29-2N")) {
                    self.slideshow.setImageInputs([
                        ImageSource(image: photoALLPlombaSecondTrack[openSensorNumber-1][1])
                    ])
                } else if photoALLPlombaSecondTrack[openSensorNumber-1].count == 2 && (photoALLPlombaSecondTrack[openSensorNumber-1].first != UIImage(named: "Group 29-2") && photoALLPlombaSecondTrack[openSensorNumber-1].first != UIImage(named: "Group 29-2N")) {
                    self.slideshow.setImageInputs([
                        ImageSource(image: photoALLPlombaSecondTrack[openSensorNumber-1][1]),
                        ImageSource(image: photoALLPlombaSecondTrack[openSensorNumber-1][0])
                    ])
    ...
    func initialize() {
        ...
        setupMapTableTextField.text = "\(photoALLPlombaSecondTrackLabel[numberSelectSensor])"
        ...
        referenceImage.frame = CGRect(x: 180, y: 21, width: 23, height: 23)
        referenceImage.center.x = 145
    ...
    @objc func textFieldDidChange(_ textField: UITextField) {
        if let string = textField.text {
            print(string)
            photoALLPlombaSecondTrackLabel[numberSelectSensor] = string
            UserDefaults.standard.set(photoALLPlombaSecondTrackLabel[numberSelectSensor], forKey: "DUTP2_\(numberSelectSensor)")
        }
